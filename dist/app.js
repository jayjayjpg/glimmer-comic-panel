...
var GuardedAppendOpcode = function (_AppendDynamicOpcode) {
    inherits(GuardedAppendOpcode, _AppendDynamicOpcode);

    function GuardedAppendOpcode() {
        classCallCheck(this, GuardedAppendOpcode);

        var _this = possibleConstructorReturn(this, _AppendDynamicOpcode.call(this));
    ...
    createClass(GuardedAppendOpcode, [{
        key: 'deopted',
        get: function get$$1() {
            return this.start === -1;
        }
...
var UpdateOpcode = function (_UpdatingOpcode) {
    ...
    function UpdateOpcode(cache, bounds$$1, upsert) {
        ...
        var _this3 = possibleConstructorReturn(this, _UpdatingOpcode.call(this));
...
var GuardedUpdateOpcode = function (_UpdateOpcode) {
    inherits(GuardedUpdateOpcode, _UpdateOpcode);

    function GuardedUpdateOpcode(reference, cache, bounds$$1, upsert) {
        classCallCheck(this, GuardedUpdateOpcode);

        var _this4 = possibleConstructorReturn(this, _UpdateOpcode.call(this, cache, bounds$$1, upsert));
...
var OptimizedCautiousAppendOpcode = function (_AppendDynamicOpcode2) {
    inherits(OptimizedCautiousAppendOpcode, _AppendDynamicOpcode2);
...
var OptimizedCautiousUpdateOpcode = function (_UpdateOpcode2) {
    inherits(OptimizedCautiousUpdateOpcode, _UpdateOpcode2);
...
var GuardedCautiousAppendOpcode = function (_GuardedAppendOpcode) {
    inherits(GuardedCautiousAppendOpcode, _GuardedAppendOpcode);

    function GuardedCautiousAppendOpcode() {
        classCallCheck(this, GuardedCautiousAppendOpcode);

        var _this7 = possibleConstructorReturn(this, _GuardedAppendOpcode.apply(this, arguments));
...
var GuardedCautiousUpdateOpcode = function (_GuardedUpdateOpcode) {
    inherits(GuardedCautiousUpdateOpcode, _GuardedUpdateOpcode);

    function GuardedCautiousUpdateOpcode() {
        classCallCheck(this, GuardedCautiousUpdateOpcode);

        var _this8 = possibleConstructorReturn(this, _GuardedUpdateOpcode.apply(this, arguments));
...
var OptimizedTrustingAppendOpcode = function (_AppendDynamicOpcode3) {
    inherits(OptimizedTrustingAppendOpcode, _AppendDynamicOpcode3);

    function OptimizedTrustingAppendOpcode() {
        classCallCheck(this, OptimizedTrustingAppendOpcode);

        var _this9 = possibleConstructorReturn(this, _AppendDynamicOpcode3.apply(this, arguments));
...
var OptimizedTrustingUpdateOpcode = function (_UpdateOpcode3) {
    inherits(OptimizedTrustingUpdateOpcode, _UpdateOpcode3);

    function OptimizedTrustingUpdateOpcode() {
        classCallCheck(this, OptimizedTrustingUpdateOpcode);

        var _this10 = possibleConstructorReturn(this, _UpdateOpcode3.apply(this, arguments));
...
var GuardedTrustingAppendOpcode = function (_GuardedAppendOpcode2) {
    inherits(GuardedTrustingAppendOpcode, _GuardedAppendOpcode2);

    function GuardedTrustingAppendOpcode() {
        classCallCheck(this, GuardedTrustingAppendOpcode);

        var _this11 = possibleConstructorReturn(this, _GuardedAppendOpcode2.apply(this, arguments));
...
var GuardedTrustingUpdateOpcode = function (_GuardedUpdateOpcode2) {
    inherits(GuardedTrustingUpdateOpcode, _GuardedUpdateOpcode2);

    function GuardedTrustingUpdateOpcode() {
        classCallCheck(this, GuardedTrustingUpdateOpcode);

        var _this12 = possibleConstructorReturn(this, _GuardedUpdateOpcode2.apply(this, arguments));
...
var ComicPanelLayer = function (_Component) {
    inherits(ComicPanelLayer, _Component);

    function ComicPanelLayer() {
        classCallCheck(this, ComicPanelLayer);

        var _this = possibleConstructorReturn(this, _Component.apply(this, arguments));

        _this.frameTotal = _this.args.frameTotal;
        return _this;
    }

    createClass(ComicPanelLayer, [{
        key: "bgStyle",
        get: function get$$1() {
    ...
    return ComicPanelLayer;
}(Component);

__decorate([tracked], ComicPanelLayer.prototype, "frameTotal", void 0);
__decorate([tracked('frameTotal')], ComicPanelLayer.prototype, "bgStyle", null);

var __ui_components_comic_panel_comic_panel_layer_template__ = { "id": "pTOL7/Ia", "block": "{\"symbols\":[],\"prelude\":[[6,\"div\"]],\"head\":[[9,\"class\",\"comic-panel-layer\"],[10,\"style\",[18,\"bgStyle\"],null],[7]],\"statements\":[[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/comic-panel/components/comic-panel/comic-panel-layer", "<template-meta>": true } };
...
var ComicPanel = function (_Component) {
    inherits(ComicPanel, _Component);

    function ComicPanel() {
        classCallCheck(this, ComicPanel);

        var _this = possibleConstructorReturn(this, _Component.apply(this, arguments));

        _this.isAnimationRunning = false;
        _this.keyframeEffects = [];
        _this.frameTotal = 6;
        _this.animation = null;
        _this.animations = [{
            layerId: 'comic-panel-layer-1',
            image: '/img/racoonhero.png',
            frameTotal: _this.frameTotal,
            keyframeSet: [{ backgroundPosition: '0 0' }, { backgroundPosition: '0 100%' }],
            keyframeOptions: {
                duration: 400,
                fill: 'none',
                direction: 'normal',
                easing: "steps(" + (_this.frameTotal - 1) + ")",
                iterations: 'Infinity'
            }
        }];
        return _this;
    ...
    ComicPanel.prototype.didInsertElement = function didInsertElement() {
        var animation = this.animations[0];
        var keyFrames = animation.keyframeSet;
        var layerElement = document.getElementById(animation.layerId);
        var timings = animation.keyframeOptions;
        var layerKeyframe = new KeyframeEffect(layerElement, keyFrames, timings);
        this.keyframeEffects = [].concat(this.keyframeEffects, [layerKeyframe]);
        var groupEffect = new GroupEffect(this.keyframeEffects);
        var animationInstance = document.timeline.play(groupEffect);
        animationInstance.pause();
        this.animation = animationInstance;
    };

    ComicPanel.prototype.togglePlayState = function togglePlayState() {
...
__decorate$1([tracked], ComicPanel.prototype, "isAnimationRunning", void 0);
__decorate$1([tracked('isAnimationRunning')], ComicPanel.prototype, "isPlaying", null);

var PlayButton = function (_Component) {
  inherits(PlayButton, _Component);
...
var __ui_components_comic_panel_play_button_template__ = { "id": "99dZ9S7y", "block": "{\"symbols\":[\"@play\",\"@pause\",\"@isPlaying\"],\"prelude\":[[6,\"button\"]],\"head\":[[7]],\"statements\":[[4,\"if\",[[19,3,[]]],null,{\"statements\":[[1,[19,2,[]],false]],\"parameters\":[]},{\"statements\":[[1,[19,1,[]],false]],\"parameters\":[]}],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/comic-panel/components/comic-panel/play-button", "<template-meta>": true } };

var __ui_components_comic_panel_template__ = { "id": "Uz8Nwnh0", "block": "{\"symbols\":[\"layer\"],\"prelude\":[[6,\"div\"]],\"head\":[[9,\"class\",\"comic-panel\"],[7]],\"statements\":[[0,\"\\n\"],[4,\"each\",[[19,0,[\"animations\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"    \"],[5,\"comic-panel-layer\",[[10,\"id\",[19,1,[\"layerId\"]],null]],[[\"@image\",\"@frameTotal\"],[[19,1,[\"image\"]],[19,1,[\"frameTotal\"]]]],{\"statements\":[],\"parameters\":[]}],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"],[5,\"play-button\",[[9,\"class\",\"play-button\"],[10,\"onclick\",[25,\"action\",[[19,0,[\"togglePlayState\"]]],null],null]],[[\"@isPlaying\",\"@play\",\"@pause\"],[[18,\"isPlaying\"],\"Play\",\"Stap it\"]],{\"statements\":[],\"parameters\":[]}],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/comic-panel/components/comic-panel", "<template-meta>": true } };

var moduleMap = { 'component:/comic-panel/components/comic-panel/comic-panel-layer': ComicPanelLayer, 'template:/comic-panel/components/comic-panel/comic-panel-layer': __ui_components_comic_panel_comic_panel_layer_template__, 'component:/comic-panel/components/comic-panel': ComicPanel, 'component:/comic-panel/components/comic-panel/play-button': PlayButton, 'template:/comic-panel/components/comic-panel/play-button': __ui_components_comic_panel_play_button_template__, 'template:/comic-panel/components/comic-panel': __ui_components_comic_panel_template__ };

var resolverConfiguration = { "app": { "name": "comic-panel", "rootName": "comic-panel" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "helper": { "definitiveCollection": "components" }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "template", "helper"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
